/**
 * Singly-linked list implementation of the OpenDSA List interface.
 */
/*
...
class LList<E> implements List<E> {
  ...
  private Link<E> curr; // Current element
  private int listSize; // Size of list

  /**
   * Constructor present to satisfy List interface. Size parameter is ignored.
   */
  LList(int size) {
    this();
  }
