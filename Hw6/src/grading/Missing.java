...
public class Missing 
{
	...
	/**
	 * Return the global default value if the given Double is null. 
	 * Otherwise return its double value.
	 * 
	...
	/**
	 * Return the given missing value if the given Double is null. 
	 * Otherwise return its double value.
	 * This method should only be used when the DEFAULT_MISSING_VALUE 
	 * is inappropriate.
	 * 
   * @param   number  The number to check
